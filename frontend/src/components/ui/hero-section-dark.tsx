    ...
    return (
      <div className={cn("relative", className)} ref={ref} {...props}>
        ...
        <section className="relative max-w-full mx-auto z-10">
          ...
          <div className="max-w-screen-xl relative z-20 mx-auto px-4 py-28 gap-12 md:px-8">
            <div className="space-y-5 max-w-4xl leading-0 lg:leading-5 mx-auto text-center">
              <h2 className="text-4xl tracking-tighter font-geist mx-auto md:text-6xl text-gray-700 dark:text-gray-300">
                {subtitle.regular}
